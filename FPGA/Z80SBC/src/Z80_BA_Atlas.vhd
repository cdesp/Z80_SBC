...
ARCHITECTURE behavioral OF Z80_BA_Atlas IS
...
BEGIN
    ...
    Z80_out.isDOut <= '0' WHEN Z80_In.Z80_IORQ_N='0' and Z80_In.Z80_RD_N='0' AND Z80_IO_ADDR=x"68" --INTERRUPT SERVICE
	  ELSE '1';              

    Z80_out.DataOut <= dOUT WHEN Z80_In.Z80_IORQ_N='0' and Z80_In.Z80_RD_N='0'  AND  Z80_IO_ADDR=x"68"
                else  "00000000";
    ...
    BEGIN
        ...
        ELSIF rising_edge(CLK) THEN
            ...
            CLRFRM <='1';
            IF Z80_In.Z80_IORQ_N='0' and Z80_In.Z80_WR_N='0' AND Z80_IO_ADDR=x"68" THEN
                CLRFRM <='0';
            END IF;
        END IF;
    END PROCESS;
...
----------------------
    ...
    Z80_Out.Z80_INT_N <= Z80_In.INT_REQ_N AND FRMINT;-- AND NOT OTSigs_in.PS2_KEYB_Int;
