...
end entity Newbrain_TOP;

architecture Structural of Newbrain_TOP is
...
begin
    ...
    ------------------------------------------------------------------
    -- 1. Newbrain Bus Arbiter & Device Decoder
    ------------------------------------------------------------------
    u_Arbiter : entity work.Z80_BA_Newbrain
        port map (
            CLK_FPGA   => CLK_FPGA,
            CLK        => CLK,
            nRESET     => nRESET,
    ...
    ------------------------------------------------------------------
    -- 2. Newbrain Video Output Core
    ------------------------------------------------------------------
    u_Video : entity work.NewbrainVideo
        port map (
            V_IN      => V_IN,
            V_OUT     => V_OUT,
            FPGA_CLK  => CLK_FPGA,
