...
end entity Atlas_TOP;

architecture Structural of Atlas_TOP is
...
begin
    ...
    ------------------------------------------------------------------
    -- 1. Atlas Bus Arbiter & Device Decoder
    ------------------------------------------------------------------
    u_Arbiter : entity work.Z80_BA_Atlas
        port map (
            CLK_FPGA   => CLK_FPGA,
            CLK        => CLK,
            nRESET     => nRESET,
    ...
    ------------------------------------------------------------------
    -- 2. Atlas Video Output Core
    ------------------------------------------------------------------
    u_Video : entity work.AtlasVideo
        port map (
            V_IN      => V_IN,
            V_OUT     => V_OUT,
            FPGA_CLK  => CLK_FPGA,
