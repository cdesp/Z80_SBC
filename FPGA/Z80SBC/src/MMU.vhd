...
BEGIN
  ...
  -- nCE0 : SRAM 1MB (128 pages: 0 to 127)
    -- Range: 0x00 to 0x7F
    nCE0 <= '0' WHEN (EXTADDR(20 DOWNTO 13) >= x"00" AND EXTADDR(20 DOWNTO 13) <= x"7F") 
                     AND nMREQ='0' ELSE '1';

    -- nCE1 : Flash 512KB (64 pages: 128 to 191)
    -- Range: 0x80 to 0xBF
    nCE1 <= '0' WHEN (EXTADDR(20 DOWNTO 13) >= x"80" AND EXTADDR(20 DOWNTO 13) <= x"BF") 
                     AND nMREQ='0' ELSE '1';
