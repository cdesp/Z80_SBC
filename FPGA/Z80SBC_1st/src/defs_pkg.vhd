...
PACKAGE defs_pkg IS
    ...
    CONSTANT CLK_SEL_PORT_ADDR : STD_LOGIC_VECTOR(7 DOWNTO 0) := x"04"; --Clock Selection
    CONSTANT UART_PORT_BASE    : STD_LOGIC_VECTOR(7 DOWNTO 0) := x"30"; --RS232 via FT232 usb
    CONSTANT C_PS2_PORT_ADDR   : STD_LOGIC_VECTOR(7 DOWNTO 0) := x"50"; --PS/2 Keyb
    CONSTANT C_VD_PORT_ADDR    : STD_LOGIC_VECTOR(7 DOWNTO 0) := x"80"; --Video Regs

    --LS138 Selection PORT Constants
    CONSTANT C_LS138_Y1     : STD_LOGIC_VECTOR(7 DOWNTO 0) := x"40"; -- FPGA PCA9665 I2C RD signal
    CONSTANT C_LS138_Y2     : STD_LOGIC_VECTOR(7 DOWNTO 0) := x"41"; -- Extra DEV2
    CONSTANT C_LS138_Y3     : STD_LOGIC_VECTOR(7 DOWNTO 0) := x"42"; -- Extra DEV1
    CONSTANT C_LS138_Y4     : STD_LOGIC_VECTOR(7 DOWNTO 0) := x"43"; -- AY38912 SEL
    CONSTANT C_LS138_Y5     : STD_LOGIC_VECTOR(7 DOWNTO 0) := x"44"; -- SN76489 CS
    CONSTANT C_LS138_Y6     : STD_LOGIC_VECTOR(7 DOWNTO 0) := x"45"; -- PCA9665 I2C SEL
    CONSTANT C_LS138_Y7     : STD_LOGIC_VECTOR(7 DOWNTO 0) := x"46"; -- CH376 CS

    CONSTANT C_PCA_BASE_ADDR : STD_LOGIC_VECTOR(7 DOWNTO 0) :=  C_LS138_Y6;--PCA9665 i2c 
